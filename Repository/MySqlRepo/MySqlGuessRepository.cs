...
{
    public class MySqlGuessRepository : IGuessRepository
    {
        private readonly MySqlGuessContext _context;

        public MySqlGuessRepository()
        {
            _context = new MySqlGuessContext();
        }
